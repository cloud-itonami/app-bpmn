...
| profile | description |
|---|---|
| `industry-ontology-bpmn` | industry-ontology-bpmn — 全産業 (ISIC 21 大分類 A〜U / 467 blueprint) の現状分析と改善活動を行い、オントロジー (wiki.yataverse.com) と BPMN プロセス定義 (app-bpmn) を記録・提案する bot |
